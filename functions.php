...
function hyphen_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'hyphen' ),
			'id'            => 'sidebar-1',
...
function hyphen_scripts() {
	wp_enqueue_style( 'hyphen-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'hyphen-style', 'rtl', 'replace' );

	wp_enqueue_script( 'hyphen-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
